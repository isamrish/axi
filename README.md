...
| [`msgraph-axi`](https://github.com/jeffreyhaen/msgraph-axi)                                            | jeffreyhaen        | Microsoft 365 / Outlook            | Read, search, draft, and send Outlook mail and manage calendars over the `m365` CLI - read-only by default, with TOON output and mutations behind `--execute`/`--confirm`.                                                                                            |
| [`frontier-axi`](https://github.com/oguzalp7/frontier-axi)                                             | oguzalp7           | Pre-flight SDLC & Cognitive Bridge | Stage ambiguous ideas and architectural inquiries until grilling settles them into tasks-axi tickets with token-efficient TOON output.                                                                                                                                |
| [`design-system-axi`](https://github.com/isamrish/design-system-axi)                                   | isamrish           | Design systems                     | Look up components, import paths, props, and examples from a design system's Storybook manifest and metadata, with a deterministic `find` that marks weak matches - Primer React first.                                                                               |
